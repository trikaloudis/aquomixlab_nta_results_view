        ...
        try:
                ...
                if not info_df.empty:
                    with st.expander("Show Dataset Information", expanded=True):
                        ...
                        for index, row in info_df.iterrows():
                            # Check if both columns exist and are not empty to prevent errors
            ...
            if st.button("Generate Boxplot"):
                ...
                if not plot_data.empty:
                    ...
                    # --- REMOVED custom download buttons to avoid kaleido error ---
                    # To download the plot, hover over the top-right corner of the chart
